...
| 7.4 | High | LVGL intercom page defined inline in both `xiaozhi-intercom.yaml` and `xiaozhi-full-aec.yaml` | Both files | Extract to `packages/ui/lvgl_intercom_page_round_240.yaml` | D |
